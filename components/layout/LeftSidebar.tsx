export default function LeftSidebar() {
    return (
        ...
        <div className="_layout_left_sidebar_wrap sticky top-[90px]">
            <div className="_layout_left_sidebar_inner mb-4">
                <div
                    className="_left_inner_area_explore _feed_inner_area bg-white shadow-sm border border-slate-100 rounded-2xl p-5">
                    <h4
                        className="_left_inner_area_explore_title _title5 mb-4 text-xs font-bold uppercase tracking-wider text-slate-400">
                        Explore
                    </h4>

                    <ul className="_left_inner_area_explore_list flex flex-col gap-1 m-0 p-0 list-none">
                        <li className="_left_inner_area_explore_item _explore_item">
                            <a href="#0"
                                className="_left_inner_area_explore_link flex items-center justify-between px-3 py-2.5 text-[14px] font-medium text-blue-600 bg-blue-50/60 rounded-xl transition-all duration-200 decoration-none hover:text-blue-700">
                                ...
                                <span
                                    className="_left_inner_area_explore_link_txt text-[10px] bg-blue-600 text-white font-bold px-1.5 py-0.5 rounded-md uppercase tracking-wide">New</span>
                            </a>
                        </li>

                        <li className="_left_inner_area_explore_item">
                            <a href="#0"
                                className="_left_inner_area_explore_link flex items-center gap-3 px-3 py-2.5 text-[14px] font-medium text-slate-600 hover:text-blue-600 hover:bg-slate-50 rounded-xl transition-all duration-200 decoration-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"
                                    viewBox="0 0 22 24">
                                    <path fill="currentColor"
                        ...
                        <li className="_left_inner_area_explore_item _explore_item">
                            <a href="#0"
                                className="_left_inner_area_explore_link flex items-center justify-between px-3 py-2.5 text-[14px] font-medium text-slate-600 hover:text-blue-600 hover:bg-slate-50 rounded-xl transition-all duration-200 decoration-none">
                                <span className="flex items-center gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"
                                        viewBox="0 0 22 24">
                                        <path fill="currentColor"
            ...
            <div className="_layout_left_sidebar_inner mb-4">
                <div
                    className="_left_inner_area_suggest _feed_inner_area bg-white shadow-sm border border-slate-100 rounded-2xl p-5">
                    <div className="_left_inner_area_suggest_content flex items-center justify-between mb-4">
                        <h4
                            className="_left_inner_area_suggest_content_title _title5 text-xs font-bold uppercase tracking-wider text-slate-400">
                            Suggested People
                        </h4>
                        <span className="_left_inner_area_suggest_content_txt text-[13px] font-semibold text-blue-600">
                            <a className="_left_inner_area_suggest_content_txt_link hover:underline decoration-none"
                                href="#0">See All</a>
                        </span>
                    </div>

                    <div className="flex flex-col gap-4">
                        <div className="_left_inner_area_suggest_info flex items-center justify-between gap-2">
                            <div className="_left_inner_area_suggest_info_box flex items-center gap-3">
                                <div className="_left_inner_area_suggest_info_image shrink-0">
                                    <a href="profile.html">
                                        <img src="assets/images/profile.png" alt="Steve"
                                            className="_info_img w-10 h-10 rounded-full object-cover ring-2 ring-slate-100" />
                                    </a>
                                </div>
                                <div className="_left_inner_area_suggest_info_txt">
                                    <a href="profile.html" className="decoration-none">
                                        <h4
                                            className="_left_inner_area_suggest_info_title text-[14px] font-semibold text-slate-800 hover:text-blue-600 transition-colors m-0">
                                            Steve Jobs
                                        </h4>
                                    </a>
                                    <p className="_left_inner_area_suggest_info_para text-[12px] text-slate-400 m-0">
                                        CEO of
                                        Apple</p>
                                </div>
                            </div>
                            <div className="_left_inner_area_suggest_info_link">
                                <a href="#0"
                                    className="_info_link text-[13px] font-medium bg-slate-100 hover:bg-blue-600 hover:text-white text-slate-700 px-3 py-1.5 rounded-xl transition-all duration-200 decoration-none">Connect</a>
                            </div>
                        </div>
                        ...
                        <div className="_left_inner_area_suggest_info flex items-center justify-between gap-2">
                            <div className="_left_inner_area_suggest_info_box flex items-center gap-3">
                                <div className="_left_inner_area_suggest_info_image shrink-0">
                                    <a href="profile.html">
                                        <img src="assets/images/profile.png" alt="Ryan"
                                            className="_info_img1 w-10 h-10 rounded-full object-cover ring-2 ring-slate-100" />
                                    </a>
                                </div>
                                <div className="_left_inner_area_suggest_info_txt">
                                    <a href="profile.html" className="decoration-none">
                        ...
                        <div className="_left_inner_area_suggest_info flex items-center justify-between gap-2">
                            <div className="_left_inner_area_suggest_info_box flex items-center gap-3">
                                <div className="_left_inner_area_suggest_info_image shrink-0">
                                    <a href="profile.html">
                                        <img src="assets/images/profile.png" alt="Dylan"
                                            className="_info_img1 w-10 h-10 rounded-full object-cover ring-2 ring-slate-100" />
                                    </a>
                                </div>
                                <div className="_left_inner_area_suggest_info_txt">
            ...
            <div className="_layout_left_sidebar_inner">
                <div
                    className="_left_inner_area_event _feed_inner_area bg-white shadow-sm border border-slate-100 rounded-2xl p-5">
                    <div className="_left_inner_event_content flex items-center justify-between mb-4">
                        <h4
                            className="_left_inner_event_title _title5 text-xs font-bold uppercase tracking-wider text-slate-400">
                            Events
                        </h4>
                        <a href="event.html"
                            className="_left_inner_event_link text-[13px] font-semibold text-blue-600 hover:underline decoration-none">See
                            all</a>
                    </div>

                    <div className="flex flex-col gap-4">
                        <a className="_left_inner_event_card_link block group decoration-none" href="event-single.html">
                            <div
                                className="_left_inner_event_card bg-slate-50/50 hover:bg-slate-50 border border-slate-100/70 rounded-xl p-3 transition-all duration-200">
                                <div
                                    className="_left_inner_event_card_iamge mb-3 overflow-hidden rounded-lg aspect-video">
                                    <img src="assets/images/feed_event1.png" alt="Event Banner"
                                        className="_card_img w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                                </div>
                                <div className="_left_inner_event_card_content flex gap-3 items-start">
                                    <div
                                        className="_left_inner_card_date shrink-0 bg-blue-50 text-center rounded-lg px-2.5 py-1 min-w-[42px]">
                                        <p
                                            className="_left_inner_card_date_para text-[15px] font-bold text-blue-600 leading-none m-0">
                                            10</p>
                                        <p
                                            className="_left_inner_card_date_para1 text-[10px] uppercase font-bold text-blue-400 tracking-wider m-0">
                                            Jul</p>
                                    </div>
                                    <div className="_left_inner_card_txt">
                                        <h4
                                            className="_left_inner_event_card_title text-[13px] font-semibold text-slate-800 group-hover:text-blue-600 transition-colors line-clamp-2 m-0">
                                            No more terrorism no more cry
                                        </h4>
                                    </div>
                                </div>
                                <hr className="_underline border-slate-100 my-2.5" />
                                <div className="_left_inner_event_bottom flex items-center justify-between text-[12px]">
                                    <p className="_left_iner_event_bottom text-slate-400 font-medium m-0">17 People
                                        Going
                                    </p>
                                    <span
                                        className="_left_iner_event_bottom_link font-semibold text-blue-600 group-hover:underline">Going</span>
                                </div>
                            </div>
                        </a>
